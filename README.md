# Powyższy projekt to baza danych z produktami w Postgresql oraz program w Pythonie który umożliwia przeglądanie listy produktu oraz dodawanie nowych. Wszystko jest stworzone w aplikacji okienkowej.
